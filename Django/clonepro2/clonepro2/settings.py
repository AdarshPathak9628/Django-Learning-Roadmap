"""
Django settings for clonepro2 project.
...
SECRET_KEY = 'django-insecure-0ciinofpuuyk$^lc0$lx7odg0^tt$=n4fx3k6yu_oqsijrd&*s'
...
WSGI_APPLICATION = 'clonepro2.wsgi.application'
